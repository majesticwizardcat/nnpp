...
int main() {
	...
	nnpp::NNPPStackVector<float> exp0 = { 10000.5f };
	nnpp::NNPPStackVector<float> exp1 = { 20000.6f };
	nnpp::NNPPStackVector<float> exp2 = { 33333.7f };
	nnpp::NNPPStackVector<float> exp3 = { 44444.8f };
